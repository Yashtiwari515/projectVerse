...
const InviteMemberDialog = ({ isDialogOpen, setIsDialogOpen }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // console.log("Redux workspace:", currentWorkspace?.id);
        // console.log("Clerk org:", organization?.id);

        if (!organization || !organization.id) {
            toast.error("No active organization found");
            return;
        }
        // console.log("Inviting from org:", organization.id);
        ...
        try{
            ...
            toast.error(err.response?.data?.error || "Failed to send invitation. Please try again.");
